...
class Ui_apbs_GroupBox(object):
    def setupUi(self, apbs_GroupBox):
        ...
        self.apbs_finegrid_doubleSpinBox = QtWidgets.QDoubleSpinBox(apbs_GroupBox)
        self.apbs_finegrid_doubleSpinBox.setObjectName("apbs_finegrid_doubleSpinBox")
        self.gridLayout_3.addWidget(self.apbs_finegrid_doubleSpinBox, 2, 1, 1, 1)
        self.gridLayout.addLayout(self.gridLayout_3, 0, 0, 1, 1)
        self.label_6.setBuddy(self.apbs_focus_lineEdit)
        self.label_5.setBuddy(self.apbs_finegrid_doubleSpinBox)
        self.label_7.setBuddy(self.apbs_outputmap_lineEdit)
